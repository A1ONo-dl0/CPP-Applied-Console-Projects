...
{
	cout << "\n" << setw(61) << "Question [" << QuestionNumber + 1 << "/" << QuezzInfo.NumberOfQuestions << "]\n";
	cout << "\n" << setw(59) << QuezzInfo.QuestionsList[QuestionNumber].FirstNum << "\n";
	cout << setw(59) << QuezzInfo.QuestionsList[QuestionNumber].SecondNum;
	cout << setw(8) << QuezzInfo.QuestionsList[QuestionNumber].OpertaionSympol << "\n";
	cout << setw(62) << string(8, (char)196) << endl;
}
...
void CorrectTheAnswer(stQuezzInfo& QuezzInfo, short QuestionNumber)
{
	...
	else
	{
		...
		cout << "\n" << setw(67) <<"Wrong Answer :-(\n";
		cout << setw(67) << "The Right Answer is: " << QuezzInfo.QuestionsList[QuestionNumber].CorrectAns << "\n";
		if (QuestionNumber != QuezzInfo.NumberOfQuestions - 1)
			system("color 4F");
		cout << "\a";
	}
...
void ASkAndCorrectTheAnswer(stQuezzInfo& QuezzInfo)
{
	for (short i = 0; i < QuezzInfo.NumberOfQuestions; i++)
	{
		...
		QuezzInfo.QuestionsList[i].PlayerAns = ReadPlayerAnswer();
...
void PrintFinallResult(stQuezzInfo QuezzInfo)
{
	...
	cout << setw(83) << string(53, (char)196) << endl;
}
	...
	do
	{
		...
		do
		{
			...
			if (Play != 'Y' && Play != 'N' && Play != 'y' && Play != 'n')
				cout << "\n" << setw(64) <<"Wrong,Please Enter Yes or No.\n\n";
